...
export const projectColorSchemes: ColorScheme[] = [
  {
    ...
    gradient:
      "bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/10",
    hover:
  ...
  },
  {
    ...
    gradient:
      "bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950/20 dark:to-emerald-900/10",
    hover:
  ...
  },
  {
    ...
    gradient:
      "bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-950/20 dark:to-amber-900/10",
    hover:
...
export const packageColorSchemes: ColorScheme[] = [
  {
    ...
    gradient:
      "bg-gradient-to-br from-indigo-50/80 to-indigo-100/70 dark:from-indigo-950/10 dark:to-indigo-900/5",
    hover:
  ...
  },
  {
    ...
    gradient:
      "bg-gradient-to-br from-sky-50/80 to-sky-100/70 dark:from-sky-950/10 dark:to-sky-900/5",
    hover:
  ...
  },
  {
    ...
    gradient:
      "bg-gradient-to-br from-teal-50/80 to-teal-100/70 dark:from-teal-950/10 dark:to-teal-900/5",
    hover:
  ...
  },
  {
    ...
    gradient:
      "bg-gradient-to-br from-rose-50/80 to-rose-100/70 dark:from-rose-950/10 dark:to-rose-900/5",
    hover:
