...
const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    description: 'Updated badges in both projects and packages sections to create a cleaner, more refined appearance with better visual hierarchy.',
    changes: [
  ...
  },
  {
    ...
    description: 'Complete overhaul transitioning from grid layout to a streamlined row-based design for improved visual flow and content scanning.',
    changes: [
  ...
  },
  {
    ...
    description: 'Completely reimagined the About Me page with modern grid layout and enhanced visual elements for more engaging personal branding.',
    changes: [
  ...
  },
  {
    ...
    category: 'UI Refinement',
    description: 'Refined CV page design focusing on professional presentation with improved typography and better print optimization.',
    changes: [
  ...
  },
  {
    ...
    description: 'Replaced slate colors with zinc for dark mode backgrounds, providing better contrast and more consistent color palette.',
    changes: [
  ...
  },
  {
    ...
    category: 'Bug Fix',
    description: 'Fixed scroll area height issues in project cards to properly utilize available space and eliminate unnecessary scrollbars.',
    changes: [
  ...
  },
  {
    ...
    description: 'Improved code organization with dedicated components and utility functions for better maintainability and reusability.',
    changes: [
  ...
  },
  {
    ...
    description: 'Replaced manual color mappings with deterministic algorithm that generates consistent colors based on technology names.',
    changes: [
  ...
  },
  {
    ...
    description: 'Modified Prettier configuration to reduce vertical spacing and improve code readability with consistent formatting.',
    changes: [
