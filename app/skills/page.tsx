          ...
          <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-start">
            <div className="max-w-3xl space-y-5 md:space-y-6">
              ...
              <div className="relative">
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-300">Showcasing {skills.length} technologies and tools</p>
              </div>
          ...
          {Object.entries(skillsByCategory).map(([category, categorySkills]) => (
            <section key={category} className="animate-fadeIn mb-8">
              ...
              <div className="relative mb-5 border-b border-gray-200 pb-2 md:mb-6 dark:border-gray-700">
                ...
                <div className="pl-5">
                  <h2 className="text-xl font-bold text-gray-800 sm:text-2xl dark:text-white">{skillCategories[category as SkillCategory].name}</h2>
