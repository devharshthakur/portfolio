				...
				<section className="mb-20">
					<div className="mx-auto max-w-6xl">
						<div className="mb-12 text-center">
							<h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-800 md:text-4xl dark:text-slate-100">
								Why Use This Template?
							</h2>
							<p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
								Built with modern web technologies and designed for developers who want a
								professional portfolio without starting from scratch.
							</p>
						</div>
						...
						<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
							<Card className="border-slate-200 bg-slate-100/80 dark:border-slate-800 dark:bg-slate-900/60">
								<CardContent className="p-6">
									...
									<p className="text-slate-600 dark:text-slate-300">
										Get your portfolio up and running in minutes with simple configuration and
										deployment.
									</p>
								</CardContent>
							</Card>
							...
							<Card className="border-slate-200 bg-slate-100/80 dark:border-slate-800 dark:bg-slate-900/60">
								<CardContent className="p-6">
									...
									<p className="text-slate-600 dark:text-slate-300">
										Built with Next.js 14, TypeScript, Tailwind CSS, and other cutting-edge
										technologies.
									</p>
								</CardContent>
							</Card>
							...
							<Card className="border-slate-200 bg-slate-100/80 dark:border-slate-800 dark:bg-slate-900/60">
								<CardContent className="p-6">
									...
									<p className="text-slate-600 dark:text-slate-300">
										Looks perfect on all devices with a mobile-first approach and fluid design
										system.
									</p>
								</CardContent>
							</Card>
							...
							<Card className="border-slate-200 bg-slate-100/80 dark:border-slate-800 dark:bg-slate-900/60">
								<CardContent className="p-6">
									...
									<p className="text-slate-600 dark:text-slate-300">
										Built-in SEO best practices to help your portfolio rank better in search
										results.
									</p>
								</CardContent>
							</Card>
							...
							<Card className="border-slate-200 bg-slate-100/80 dark:border-slate-800 dark:bg-slate-900/60">
								<CardContent className="p-6">
									...
									<p className="text-slate-600 dark:text-slate-300">
										Optimized for speed with lazy loading, image optimization, and efficient
										bundling.
									</p>
								</CardContent>
							</Card>
							...
							<Card className="border-slate-200 bg-slate-100/80 dark:border-slate-800 dark:bg-slate-900/60">
								<CardContent className="p-6">
									...
									<p className="text-slate-600 dark:text-slate-300">
										Well-structured, documented code that's easy to understand and customize.
									</p>
								</CardContent>
							</Card>
						</div>
					...
					<div className="mx-auto max-w-6xl">
						<div className="rounded-2xl border border-slate-200 bg-slate-100/80 p-8 md:p-12 dark:border-slate-800 dark:bg-slate-900/60">
							...
							<div className="mb-8 grid gap-8 md:grid-cols-2">
								<div>
									...
									<p className="mb-4 text-slate-600 dark:text-slate-300">
										I'm actively working on optimizing the code structure to make adoption as a
										template easier. Your contributions are welcome to help improve this project for
								...
								<div>
									...
									<p className="mb-4 text-slate-600 dark:text-slate-300">
										Follow these simple steps to use this portfolio as your template:
									</p>
							...
							<div className="flex flex-wrap gap-4">
								<Button
									className="bg-zinc-700/90 text-white shadow-md hover:bg-zinc-800/90 dark:bg-zinc-600/90 dark:hover:bg-zinc-700/90"
									asChild
								>
									<a
				...
				<section className="mb-20">
					<div className="mx-auto max-w-4xl text-center">
						<div className="rounded-2xl border border-amber-200 bg-amber-100/80 p-8 md:p-12 dark:border-amber-800 dark:bg-amber-900/40">
							...
							<h2 className="mb-4 text-2xl font-bold text-slate-800 md:text-3xl dark:text-slate-100">
								Show Your Support
							</h2>
							<p className="mb-6 text-lg text-slate-600 dark:text-slate-300">
								If you find this portfolio template helpful, please consider giving it a star on
								GitHub. It helps others discover the project and motivates me to keep improving it!
							</p>
							<Button
								size="lg"
