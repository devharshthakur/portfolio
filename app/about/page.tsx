									...
									<CardContent className="relative z-10 px-6 pt-20 pb-6">
										...
										<div className="mb-6 space-y-3">
											<div className="flex items-center gap-3 rounded-xl border border-slate-200/80 bg-slate-50 px-4 py-3 transition-all duration-200 hover:border-slate-300 hover:shadow-md dark:border-slate-700/80 dark:bg-slate-800/50 dark:hover:border-slate-600">
												...
												<div>
													<div className="font-mono text-xs tracking-wide text-slate-500 uppercase dark:text-slate-400">
														Location
													</div>
										...
										<div className="space-y-4">
											<h3 className="font-mono text-sm tracking-wider text-slate-500 uppercase dark:text-slate-400">
												Connect with me
											</h3>
								...
								<div className="p-6">
									...
									<div className="mb-4 rounded-xl border border-blue-100 bg-blue-50/50 p-4 dark:border-blue-800/40 dark:bg-blue-900/20">
										<p className="leading-relaxed text-slate-600 dark:text-slate-300">
											...
											, pursuing BE in Computer Engineering. I specialize in Next.js, React, and
								...
								<div className="p-6">
									...
									<div className="space-y-8">
										<div className="relative rounded-xl border border-indigo-100 bg-indigo-50/30 p-4 pb-8 pl-10 dark:border-indigo-800/30 dark:bg-indigo-900/10">
											...
											<h3 className="mb-3 ml-2 text-lg font-semibold tracking-tight text-indigo-700 dark:text-indigo-400">
												My Background
											</h3>

											<p className="leading-relaxed text-slate-600 dark:text-slate-300">
												I&apos;ve always been fascinated by the intersection of technology and
												design. My interest in understanding how frontend interacts with backend in
												web applications, how it internally works, and how they are deployed led me
												to backend development in JavaScript (Node.js). I&apos;m particularly
												interested in JavaScript/TypeScript and related technologies for web
												development.
											</p>
										</div>
										...
										<div className="relative rounded-xl border border-indigo-100 bg-indigo-50/30 p-4 pl-10 dark:border-indigo-800/30 dark:bg-indigo-900/10">
											...
											<p className="leading-relaxed text-slate-600 dark:text-slate-300">
												I develop applications in Next.js. During this time, I&apos;ve had the
												opportunity to work with a variety of popular technologies and managed
												services on a wide range of projects. I&apos;ve learned to connect
												databases, create APIs, and develop projects in monorepos using Turborepo.
								...
								<div className="p-6">
									...
									<div className="space-y-6">
										...
										<div className="rounded-xl border border-rose-100 bg-rose-50/30 p-4 transition-all duration-200 hover:border-rose-200 hover:shadow-md dark:border-rose-800/30 dark:bg-rose-900/10 dark:hover:border-rose-700/30">
											...
											<p className="leading-relaxed text-slate-600 dark:text-slate-300">
												Learning Rust for its memory safety, zero-cost abstractions, and powerful
												concurrency model. Exploring systems programming and high-performance web
										...
										<div className="rounded-xl border border-rose-100 bg-rose-50/30 p-4 transition-all duration-200 hover:border-rose-200 hover:shadow-md dark:border-rose-800/30 dark:bg-rose-900/10 dark:hover:border-rose-700/30">
											...
											<p className="leading-relaxed text-slate-600 dark:text-slate-300">
												Diving into JavaScript testing with Vitest, focusing on writing effective
												unit and integration tests for frontend and backend applications to improve
