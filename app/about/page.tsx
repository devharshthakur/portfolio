...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-tr from-background via-background to-indigo-50/10 dark:to-indigo-950/10 overflow-hidden">
      ...
      <nav className="sticky top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b border-slate-200/50 dark:border-slate-800/50 py-4 px-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Button
            asChild
            variant="outline"
            size="icon"
            className="rounded-md h-10 w-10 border-amber-200"
          >
            <Link href="/">
          ...
          <div className="flex items-center gap-1.5 mr-1.5 text-xl font-semibold text-slate-600 dark:text-slate-300">
            ...
            <div className="lg:col-span-5 xl:col-span-4">
              <div className="sticky">
                <Card className="overflow-auto border-0 shadow-lg bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-xl">
                  <div className="relative h-32 bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-t-xl">
                    <div className="absolute -bottom-16 inset-x-0 flex justify-center">
                      <div className="overflow-hidden h-32 w-32 border-4 border-white dark:border-slate-800 shadow-xl ring-2 ring-blue-500/30 dark:ring-blue-700/30">
                        <Avatar className="h-full w-full overflow-hidden rounded-none">
                          ...
                          />
                          <AvatarFallback className="bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200 text-xl font-bold">
                            HT
                          </AvatarFallback>
                        </Avatar>
                      </div>
                    ...
                    <div className="space-y-6">
                      <div className="relative pl-8 pb-6 border-l-2 border-indigo-200 dark:border-indigo-800/50">
                        ...
                        <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                          ...
                          of technology and design. My interest in understanding
                          how frontend interacts with backend in web
                          applications, how it internally works, and how they
                          are deployed led me to backend development in
                          JavaScript (Node.js). I&apos;m particularly interested
                          in JavaScript/TypeScript and related technologies for
                          web development.
                        </p>
                      </div>
                      ...
                      <div className="relative pl-8">
                        ...
                        <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                          ...
                          I&apos;ve had the opportunity to work with a variety
                          of popular technologies and managed services on a wide
                          range of projects. I&apos;ve learned to connect
                          databases, create APIs, and develop projects in
                          monorepos using Turborepo. As a fresher, I&apos;m
                          always eager to learn and grow in the field of web
                          development.
                        </p>
                      </div>
                    </div>
                ...
                <div className="border-l-4 border-rose-500 dark:border-rose-600">
                  <div className="p-6">
                    ...
                    <div className="pl-8 relative">
                      ...
                      <div>
                        <h3 className="font-semibold text-rose-700 dark:text-rose-400 mb-2">
                          Rust Programming Language
                        </h3>
                        <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                          Exploring systems programming with Rust for
                          performance-critical applications and gaining a deeper
