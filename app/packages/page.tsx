  ...
  return (
    <div className="relative min-h-screen w-full bg-zinc-50 dark:bg-zinc-950 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-zinc-200 dark:bg-zinc-800 rounded-full opacity-15 blur-2xl"></div>
        <div className="absolute bottom-1/3 right-1/3 w-64 h-64 bg-zinc-300 dark:bg-zinc-700 rounded-full opacity-15 blur-2xl"></div>
      </div>
      {/* Main content */}
      <div className="relative flex flex-col items-center justify-center min-h-screen px-4 py-10 z-10">
        <div className="w-full max-w-3xl mx-auto text-center">
          <Construction className="h-16 w-16 mx-auto mb-5 text-zinc-600 dark:text-zinc-400" />
          ...
          <div className="w-full max-w-lg mx-auto mb-8">
            <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 mb-6">
              We're currently working on building something amazing for you.
            ...
            <div className="relative h-2 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden max-w-xs mx-auto mb-8">
              <div className="absolute top-0 left-0 h-full w-2/3 bg-gradient-to-r from-zinc-400 to-zinc-600 dark:from-zinc-500 dark:to-zinc-700 animate-pulse rounded-full"></div>
            </div>
          </div>
          <Button
            variant="default"
