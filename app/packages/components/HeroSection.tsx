...
export function HeroSection({ packages }: HeroSectionProps) {
  return (
    <section className="relative p-5 sm:p-8 md:p-10 rounded-xl md:rounded-2xl bg-gradient-to-br from-white to-purple-50/70 dark:from-gray-800 dark:to-purple-900/60 backdrop-blur-sm shadow-md overflow-hidden mb-8 md:mb-12 border-2 border-slate-200/70 dark:border-slate-700/70">
      <div className="flex flex-col md:flex-row md:items-start gap-6 relative z-10">
        <div className="space-y-5 md:space-y-6 max-w-3xl">
          {/* Title */}
          <div className="relative">
            <div className="flex items-center gap-2 mb-2">
              <span className="hidden sm:flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-purple-400 to-indigo-500 dark:from-purple-400 dark:to-indigo-400 shadow-md">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-800 dark:text-white mb-1">
              ...
              <span className="inline-block relative bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-500 dark:from-purple-400 dark:to-indigo-400">
                Packages
                <span className="absolute -bottom-1 left-0 w-full h-1 bg-gradient-to-r from-purple-400 to-indigo-500 dark:from-purple-400 dark:to-indigo-400 rounded-full" />
              </span>
            </h1>
