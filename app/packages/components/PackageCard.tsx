...
export function PackageCard({ pkg, index }: PackageCardProps) {
  ...
  return (
    <Card
      className="group overflow-hidden transition-all duration-300 hover:shadow-xl border-2 border-border animate-fadeIn relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm hover:border-purple-300 dark:hover:border-purple-700"
      style={{ animationDelay: `${index * 100}ms` }}
    >
      <CardHeader className="pb-0 pt-5">
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-gradient-to-br from-white to-purple-50 dark:from-gray-800 dark:to-purple-900/50 border-2 border-purple-200 dark:border-purple-700/70 shadow-md transition-all duration-300 group-hover:shadow-lg">
              <FaNpm className="h-6 w-6 text-red-500 dark:text-red-400" />
            </div>
            <div>
              <CardTitle className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-300 dark:to-indigo-400">
                {pkg.name}
              </CardTitle>
              {pkg.version && (
                <Badge
          ...
          {pkg.downloads && (
            <div className="flex items-center gap-1 px-2.5 py-1.5 rounded-md bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 text-blue-600 dark:text-blue-300 border border-blue-200 dark:border-blue-700/50 shadow-sm text-sm font-medium">
      ...
      <CardContent className="pt-5 space-y-4">
        ...
        <div className="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700/50 bg-gray-50 dark:bg-gray-800/50 p-2 overflow-hidden">
          <div className="flex items-center space-x-2 pl-2">
            <FaNpm className="h-4 w-4 text-red-500 dark:text-red-400 flex-shrink-0" />
        ...
        {(pkg.publishedDate || pkg.lastUpdated) && (
          <div className="rounded-lg border border-gray-200 dark:border-gray-700/50 bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-800/30 dark:to-gray-800/30 p-3 overflow-hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {pkg.publishedDate && (
                <div className="flex items-center space-x-2 px-3 py-1.5 bg-white/70 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600/50 shadow-sm">
        ...
        {/* Description */}
        <div className="text-sm leading-relaxed text-gray-600 dark:text-gray-300 bg-gradient-to-br from-white to-purple-50/30 dark:from-gray-800/50 dark:to-purple-900/20 p-4 rounded-lg border border-gray-200 dark:border-gray-700/50 shadow-sm transition-all duration-300 group-hover:shadow-md">
