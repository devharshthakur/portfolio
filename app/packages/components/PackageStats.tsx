...
export function PackageStats({ packages }: PackageStatsProps) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 pt-2">
      {/* Total Packages */}
      <div className="col-span-1 bg-linear-to-br from-purple-50 to-indigo-50 dark:from-purple-900/30 dark:to-indigo-900/30 rounded-lg p-3 border border-purple-200/50 dark:border-purple-600/50 shadow-xs">
      ...
      {/* Total Downloads */}
      <div className="col-span-1 bg-linear-to-br from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 rounded-lg p-3 border border-blue-200/50 dark:border-blue-600/50 shadow-xs">
      ...
      {/* Technologies */}
      <div className="col-span-1 bg-linear-to-br from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 rounded-lg p-3 border border-amber-200/50 dark:border-amber-600/50 shadow-xs">
