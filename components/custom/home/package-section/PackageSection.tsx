			...
			<div className="relative z-10 container max-w-full overflow-x-hidden px-4 md:px-8 lg:px-12">
				<div className="mb-6 flex items-center justify-between">
					<div className="flex items-center gap-2">
						...
						<h2 className="font-mono text-3xl font-bold tracking-[-0.02em] text-red-900 dark:text-red-300">
							NPM Packages
						</h2>
					</div>
					<Button
						variant="outline"
						className="border-2 border-red-500/90 bg-red-600/5 font-mono text-sm text-red-800 shadow-sm hover:bg-red-100/90 dark:border-red-600/80 dark:text-red-300 dark:hover:bg-red-800/60"
						asChild
					>
						<Link href="/packages">
							<Archive />
