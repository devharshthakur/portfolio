	...
	return (
		<>
			<div className="flex flex-col justify-center rounded-r-2xl border-2 border-zinc-300 bg-gray-50 p-8 shadow-xs md:p-10 dark:border-zinc-700 dark:bg-zinc-800/50">
				<div className="mb-8">
					<h3 className="font-mono text-2xl font-bold text-zinc-800 dark:text-zinc-100">
						Send a Message
					</h3>
			...
			{status === "error" && (
				<Alert
					variant="destructive"
					className="animate-in fade-in slide-in-from-bottom-5 fixed right-4 bottom-4 max-w-md"
				>
					...
					<AlertDescription>
						There was a problem sending your message. Please try again or contact me directly via
						email.
					</AlertDescription>
				</Alert>
			)}
